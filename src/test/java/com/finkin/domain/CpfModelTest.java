...
class CpfModelTest {
    ...
    void shouldAcceptValidCpf(String cpf) {
        assertThatNoException().isThrownBy(() -> new CpfModel(cpf));
    }
    ...
    void shouldRejectInvalidCpf(String cpf) {
        assertThatThrownBy(() -> new CpfModel(cpf))
            .isInstanceOf(CpfModel.InvalidCpfException.class);
    }

    @Test
    void shouldNormalizePunctuation() {
        var cpf = new CpfModel("529.982.247-25");
        assertThat(cpf.getValue()).isEqualTo("52998224725");
    }

    @Test
    void shouldFormatCorrectly() {
        var cpf = new CpfModel("52998224725");
        assertThat(cpf.formatted()).isEqualTo("529.982.247-25");
    }

    @Test
    void shouldBeEqualByValue() {
        var a = new CpfModel("529.982.247-25");
        var b = new CpfModel("52998224725");
