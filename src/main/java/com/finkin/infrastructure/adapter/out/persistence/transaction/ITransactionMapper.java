package com.finkin.infrastructure.adapter.out.persistence.transaction;
...
public interface ITransactionMapper {
    ...
    @Mapping(target = "type", expression = "java(com.finkin.domain.model.transaction.TransactionType.valueOf(entity.getType()))")
    @Mapping(target = "status", expression = "java(com.finkin.domain.model.transaction.TransactionStatus.valueOf(entity.getStatus()))")
