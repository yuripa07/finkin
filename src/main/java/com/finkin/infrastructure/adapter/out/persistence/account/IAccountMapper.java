...
public interface IAccountMapper {
    ...
    @Mapping(target = "type", expression = "java(com.finkin.domain.model.account.AccountType.valueOf(entity.getType()))")
    @Mapping(target = "status", expression = "java(com.finkin.domain.model.account.AccountStatus.valueOf(entity.getStatus()))")
